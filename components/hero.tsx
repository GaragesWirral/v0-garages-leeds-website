          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex flex-col">
                <Button 
                  size="lg" 
                  className="text-lg h-14 px-8 bg-green-500 hover:bg-green-600" // Green for primary "go"/security
                  asChild
                >
                  <a href="#enquiry">Secure Your Garage Now</a>
                </Button>
                <p className="text-sm text-muted-foreground mt-2">Get availability & quote in 24 hours – no commitment</p> {/* Micro-copy */}
              </div>
              <Button 
                variant="outline" 
                size="lg" 
                ...
                asChild
              >
                <a href="tel:07519667044" title="Speak to our team: 07519 667044 – available 9am-6pm"> {/* Micro-copy in title */}
